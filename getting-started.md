...
1.  From the **Feature** menu, ensure that `AGE` is selected to see details about  `AGE` data monitoring.
    ...
    - For information about interpreting the visualization of the data points at a specific hour, see [Working with monitored data > Data visualization](/docs/services/ai-openscale-icp/insight-timechart.html#itc-data-visual).
...
1.  Paste the copied transaction ID into the search box and press the Enter key on your keyboard.
    ...
    - For information about interpreting transaction explainability, see [Working with monitored data > Monitoring Explainability](/docs/services/ai-openscale-icp/insight-timechart.html#itc-monitor-explain).
